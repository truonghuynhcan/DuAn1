            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="features-details">
                        <h3 class="title">We give you the endless possibilities to express yourself to the world</h3>
                        <!-- /.title -->
                        <p class="description">
                            This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.
                            Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem
    ...
    <div class="section-padding">
        <div class="container">
            <div id="testimonial-slider" class="testimonial-slider carousel slide">
                ...
                <div class="carousel-inner text-center">
                    <div class="item active">
                        <div class="client-avatar"><img src="images/service/avatar.jpg" alt="Client-avatar"></div>
                        <!-- /.client-avatar -->
                        <p class="description">
                            He seemed to brace himself for a great effort, and then started on the queerest rigmarole. I
                            didn't get hold of it at first, and I had to stop and ask him questions
                        </p><!-- /.description -->
                    ...
                    <div class="item">
                        ...
                        <!-- /.client-avatar -->
                        <p class="description">
                            He was an American and started to see the world. He wrote a bit, and acted as war
                            correspondent for a Chicago paper, and spent a year or two in South-Eastern Europe.
                        </p><!-- /.description -->
                        <div class="client-details">
                    ...
                    <div class="item">
                        ...
                        <!-- /.client-avatar -->
                        <p class="description">
                            He had played about with politics, he told me, at first for the interest of them, and then
                            because he couldn't help himself. I read him as a sharp, restless fellow
                        </p><!-- /.description -->
                        <div class="client-details">
            ...
            <div class="clients-logo">
                <div class="col-sm-3">
                    <div class="item bg-gray"><a href="#"><img src="images/brand/1.png" alt="Brand Logo"></a></div>
                    <!-- /.item -->
                </div>
                <div class="col-sm-3">
                    <div class="item bg-gray"><a href="#"><img src="images/brand/2.png" alt="Brand Logo"></a></div>
                    <!-- /.item -->
                </div>
                <div class="col-sm-3">
                    <div class="item bg-gray"><a href="#"><img src="images/brand/3.png" alt="Brand Logo"></a></div>
                    <!-- /.item -->
                </div>
                <div class="col-sm-3">
                    <div class="item bg-gray"><a href="#"><img src="images/brand/4.png" alt="Brand Logo"></a></div>
                    <!-- /.item -->
                </div>
            </div><!-- /.client-logo -->
