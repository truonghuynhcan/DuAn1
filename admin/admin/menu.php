<ul class="nav nav-tabs">
    ...
    <!-- <li class="nav-item">
    <a class="nav-link"  <?php if($page=='loaitin') echo 'active'  ?>  data-toggle="tab" href="index.php?page=loaitin">Danh mục </a>
    </li> -->
    <li class="nav-item">
    <a class="nav-link" <?php if($page=='tin') echo 'active'  ?>  data-toggle="tab" href="index.php?page=tin">Quản lý Sản phẩm </a>
    </li>
    <li class="nav-item">
