...
<main>
    <div class="head-title">
        <div class="left">
                ...
                <ul class="breadcrumb">
                    <li>
                        <a href="index.php?pg=ad&active=admin_management" class="active">Quản lý Admin</a>
                    </li>
                    <li><i class='bx bx-chevron-right'></i></li>
                    <li>
                        <a class="" href="#">Cập nhật Admin</a>
                    </li>
                </ul>
        </div>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <form action="index.php?pg=ad&active=admin_update&userId=<?= $user['Id'] ?>" method="post" class="row">
