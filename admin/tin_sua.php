...
if (checklogin()==true){  header('Location: login.php'); exit(); }
...
<body>
   ...
   <div class="tab-content">
      ...
      <div class="col-10 m-auto" >
         <h2 class="py-2 text-center h4 ">CHỈNH SỬA SẢN PHẨM</h2>
         ...
         <div class="mb-3">
            ...
            <div class="mb-3">
                  <label>Tác Giả</label>
                  <input class="form-control bg-light" type="text" name="Tác giả" value="<?= $_POST['tacgia']??"" ?>">
            </div>
            <div class="mb-3">
                  <label>NXB</label>
                  <input class="form-control bg-light" type="text" name="NXB" value="<?= $_POST['NXB']??"" ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                  <label>Địa chỉ hình 1</label>
                  <input class="form-control bg-light" type="text" name="urlHinh" value="<?= $_POST['urlHinh']??"" ?>">
            </div>
            <div class="mb-3">
                  <label>Địa chỉ hình 2</label>
                  <input class="form-control bg-light" type="text" name="urlHinh" value="<?= $_POST['urlHinh']??"" ?>">
            </div>
            <div class="mb-3">
                  <label>Địa chỉ hình 3</label>
                  <input class="form-control bg-light" type="text" name="urlHinh" value="<?= $_POST['urlHinh']??"" ?>">
            </div>
            <div class="mb-3">
               <label>Trong Thể loại:</label>
